/*
    boolean add(E e);           // aggiunge in coda, ritorna true se la collection cambia post operazione
    void addFirst(E e);         // aggiunge in testa
    void addLast(T e);          // aggiunge in coda
    void clear();               // elimina tutti gli elementi della lista
    boolean contains(E e);      // true se la lista contiene l'elemento e
